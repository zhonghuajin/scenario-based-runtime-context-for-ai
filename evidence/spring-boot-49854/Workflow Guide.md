...
# 5. Analyze Logs to Extract Denoised Data
...
.\process-logs-demo.ps1 `
    ...
    -EventsFile "/path/to/spring-boot-pathpatternrequestmatcher/instrumentor-log-20260411_203220-junit-listener.txt"
```
...
# 7. Submit the Prompt to AI for Analysis and Get Results
